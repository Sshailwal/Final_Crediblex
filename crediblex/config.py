...
# ─────────────────────────────────────────────────────────────────────────────
BATCH_SIZE        = 8     # Safe for RTX 4050 6GB with DeBERTa-v3-base + 4 heads at MAX_LEN=256
MAX_LEN           = 256   # 256 tokens (NOT 512) — RTX 4050 6GB cannot fit DeBERTa+4heads at 512/batch=8
EPOCHS            = 7
LEARNING_RATE     = 2e-5
